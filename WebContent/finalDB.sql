...
CREATE TABLE `appraisalinfo` (
  ...
  `AppraisalStar` float(11) DEFAULT NULL,
...
CREATE TABLE `bookinginfo` (
  ...
  `bookingName` varchar(20) NOT NULL,
  `bookingPhone` varchar(40) NOT NULL,
  `bookingTime` datetime NOT NULL,
  `bookingDemand` varchar(200) NOT NULL,
  `bookingApprove` varchar(3) NOT NULL,
  `foodNumber` int(11) NOT NULL,
  `foodStoreName` varchar(45) NOT NULL,
  `bookingGroup` varchar(45) NOT NULL,
  `UserNumber` int(11) NOT NULL,
  PRIMARY KEY (`bookingNum`),
  KEY `bookingId_fk2_idx` (`foodNumber`),
  KEY `bookingId_fk1_idx` (`UserNumber`),
  CONSTRAINT `bookingId_fk1` FOREIGN KEY (`UserNumber`) REFERENCES `userinfo` (`UserNumber`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `bookingId_fk2` FOREIGN KEY (`foodNumber`) REFERENCES `foodinfo` (`FoodNumber`) ON DELETE NO ACTION ON UPDATE NO ACTION
